...
const Button = forwardRef<HTMLButtonElement | HTMLAnchorElement, ButtonProps | LinkProps>(
    ({
        ...
        const baseStyles: React.CSSProperties = {
            ...
            width: fullWidth ? '100%' : sizeStyles.width,
        ...
        // Hover styles (will be applied via CSS-in-JS or classes)
        const hoverStyles = `
            &:hover:not(:disabled) {
                background-color: ${variantStyles.hover.backgroundColor};
                color: ${(variantStyles.hover as { color?: string })?.color || variantStyles.color};
...
// Optional: Export specific button variants for convenience
