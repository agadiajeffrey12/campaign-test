...
import { MiniAddButton, PrimaryButton, TertiaryButton } from '@/components/reuseables/buttons'
    ...
    <div className="w-full space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <PrimaryButton 
          ...
          className="mt-4 md:inline-flex hidden"
        >
          Create campaign
        </PrimaryButton>
        <MiniAddButton isLink href=' href="/dashboard/campaign?screen=create&type=campaign' className='md:hidden flex'/>
      </div>
            ...
            {paginatedCampaigns.length > 0 ? (
              paginatedCampaigns.map((campaign) => (
                <TableRow key={campaign.id} className="border-b hover:bg-gray-50/50">
                  ...
                  <TableCell>
                    <TertiaryButton size='small' className='inline-flex' isLink href={`/dashboard/campaign/${campaign.id}/report`}>
                        View Report
                    </TertiaryButton>
                  </TableCell>
                </TableRow>
      ...
      {/* Pagination */}
      <div className="flex border-t p-2 items-center justify-between">
        <Button
          variant="outline"
          size="sm"
