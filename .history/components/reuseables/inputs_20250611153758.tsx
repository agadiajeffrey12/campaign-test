...
const Input: React.FC<InputProps> = ({
  ...
  const sizeStyles = {
    ...
    lg: { height: DEFAULT_HEIGHT, padding: '12px 30px', fontSize: '18px' }
  };
      ...
      />
      {
        hasPromptText && promptText && (
          <div className='flex gap-2'>
            <span className='h-4 w-4 flex items-center justify-center rounded-full text-[10px] text-white bg-secondary-text'>!</span>
