...
const MessageDetailModal = ({ 
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent 
        className="fixed right-0 bottom-0 h-full w-[400px] max-w-none p-0 m-0 translate-x-0 data-[state=closed]:translate-x-full data-[state=open]:translate-x-0 transition-transform duration-300 ease-in-out border-l shadow-2xl rounded-none overflow-hidden"
