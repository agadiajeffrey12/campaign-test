...
const CampaignDetailModal = ({ 
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent 
        className="fixed right-0 top-0 h-full w-[400px] max-w-none p-0 translate-x-0 data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right border-l shadow-2xl rounded-none"
      >
