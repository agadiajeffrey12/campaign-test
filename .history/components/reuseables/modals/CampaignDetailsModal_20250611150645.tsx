...
const CampaignDetailModal = ({ 
  ...
  return (
    ...
    <DialogContent 
      className="fixed left-0 top-[90px] h-full w-[400px] max-w-none p-0 m-0 translate-x-0 data-[state=closed]:translate-x-full data-[state=open]:translate-x-0 transition-transform duration-300 ease-in-out border-l shadow-2xl rounded-none overflow-hidden"
