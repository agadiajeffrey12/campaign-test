...
import { Editor, EditorState, RichUtils, getDefaultKeyBinding, KeyBindingUtil, convertToRaw, convertFromRaw, Modifier } from 'draft-js';
...
const EmailComposer = () => {
  ...
  const handleTemplateSelect = (template: Template) => {
    ...
    const contentState = EditorState.createWithText(template.content).getCurrentContent();
...
const mapKeyToEditorCommand = (e: MapKeyToEditorCommandEvent): string | void => {
    if (e.keyCode === 9 /* TAB */) {
