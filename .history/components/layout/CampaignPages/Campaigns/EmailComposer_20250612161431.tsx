...
type MapKeyToEditorCommandEvent = React.KeyboardEvent<HTMLDivElement>;
...
const toggleInlineStyle = (inlineStyle: ToggleInlineStyleProps['inlineStyle']): void => {
  ...
  return (
    <div className="md:w-[677px] w-full h-[549px] mb-6">
      {/* Template Section */}
      <div className="mb-6">
      ...
      <div className="space-y-3">
        <PrimaryButton fullWidth onClick={() => handleStepChange && handleStepChange(3)} >
          Save and continue
        </PrimaryButton >
        <TertiaryButton fullWidth onClick={()=> handleStepChange && handleStepChange(2)} className="w-full text-gray-600 py-2 px-4 hover:text-gray-800 transition-colors">
          Cancel
        </TertiaryButton >
      </div>
    </div>
