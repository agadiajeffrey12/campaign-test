...
const ConfirmAndSend = (
  ...
  return (
    <div className='w-[830px] h-[1700px]  flex-col space-y-[32px]'>
        <h2 className='text-[14px] text-center text-secondary-text font-[400]'>Confirm your message and delivery settings.</h2>
<Input
            label="Name"
