    ...
    return (
      <div className="md:w-[677px] w-full h-[549px] mb-6">
        ...
        <div className="space-x-3 flex justify-end">
          <TertiaryButton size='small' disabled={!selectedTemplate || !editorState.getCurrentContent().hasText()} onClick={() => {
            setSelectedTemplate('');
            setEditorState(EditorState.createEmpty());
          }}>
            Cancel
          </TertiaryButton >
          <PrimaryButton size='small' disabled={!selectedTemplate || !editorState.getCurrentContent().hasText()}>
            Create template
          </PrimaryButton >
        </div>
      </div>
