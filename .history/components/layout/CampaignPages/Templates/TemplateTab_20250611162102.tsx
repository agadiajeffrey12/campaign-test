  ...
  return (
    <div className='space-y-4 '>
        <div className='flex w-full flex-col md:flex-row md:items-center justify-between'>
            ...
            <div className='flex justify-between space-x-3 mt-3 md:mt-0'>
                ...
                <MiniAddButton className='md:hidden w-[48px] h-[48px]' isLink href='/dashboard/campaign?screen=create&type=template'>
                </MiniAddButton>
            </div>
        </div>
        <TemplateCarditem
