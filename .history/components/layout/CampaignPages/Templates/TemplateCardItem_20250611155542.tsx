...
export function TemplateCarditem({
  ...
  return (
    <Card className={cn('w-full min-h-[134px] h-fit bg-white shadow-sm border border-gray-200', className)}>
      <CardContent className="">
        ...
        <p className="text-gray-700 text-base max-w-[70%] leading-relaxed mb-4 line-clamp-3">
          {content}
        </p>
