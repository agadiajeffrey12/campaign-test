...
const EmptyState = ({ title, description, actionText, actionIcon }: EmptyStateProps) => {
    ...
    const createAction = type === 'campaign' ? `/dashboard/campaign?screen=create&&type=${type}` : '/dashboard/template?tabcreate';
    return (
        <div className="flex flex-col items-center justify-center py-12 text-center">
                <Image src={'/jet.png'} width={200} height={200} alt='jet'/>
