...
import CampaignDetailModal from '../modals/CampaignDetailsModal'
...
const ReportsDataTable = (
  ...
  // Modal states
  const [selectedCampaign, setSelectedCampaign] = useState<ReportData | null>(null)
  ...
  // Modal handlers
  const handleViewCampaign = (campaign: ReportData) => {
