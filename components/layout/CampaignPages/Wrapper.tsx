  ...
  return (
    <div className="w-full flex flex-col gap-4 md:flex-row md:justify-between md:items-center">
      <div className="flex flex-col gap-1">
        <h2 className="text-[20px] md:text-[24px] text-dark-blue font-medium">
          Campaigns
        </h2>
        <p className="text-secondary-text text-sm md:text-[14px]">
          Manage all your email campaigns here.
        </p>
      </div>

      {showTabs && (
        <TabsList className="grid grid-cols-2 w-full md:w-auto md:grid-cols-2 gap-2">
          <TabsTrigger
            value="campaigns"
